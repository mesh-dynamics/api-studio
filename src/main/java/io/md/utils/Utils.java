...
public class Utils {
	...
	public static<T> Optional<T> handleSafe(Supplier<T> supplier){
		try{
	...
	public static<T,U> Optional<U> safeExecute(T val , Function<T , U> mapperFn){
		try{
