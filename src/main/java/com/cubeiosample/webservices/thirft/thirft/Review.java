...
public class Review implements org.apache.thrift.TBase<Review, Review._Fields>, java.io.Serializable, Cloneable, Comparable<Review> {
  ...
  public Review setReviewer(@org.apache.thrift.annotation.Nullable String reviewer) {
    this.reviewer = reviewer;
    return this;
  }
  ...
  public Review setText(@org.apache.thrift.annotation.Nullable String text) {
    this.text = text;
    return this;
  }
