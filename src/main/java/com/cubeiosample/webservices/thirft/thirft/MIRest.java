...
public class MIRest {
  ...
  public interface Iface {
    ...
    public ListMovieResult listMovies(String filmName, String keyWord, String actor) throws GenericMIRestException, TException;
  ...
  public interface AsyncIface {
    ...
    public void healthCheck(org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler) throws TException;

    public void listMovies(String filmName, String keyWord, String actor, org.apache.thrift.async.AsyncMethodCallback<ListMovieResult> resultHandler) throws TException;

    public void rentMovie(RentalInfo rentalInfo, org.apache.thrift.async.AsyncMethodCallback<RentMovieResult> resultHandler) throws TException;

    public void listStores(int filmId, org.apache.thrift.async.AsyncMethodCallback<ListStoreResult> resultHandler) throws TException;

    public void returnMovie(ReturnInfo returnInfo, org.apache.thrift.async.AsyncMethodCallback<ReturnMovieResult> resultHandler) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_healthCheck() throws TException
    {
      healthCheck_args args = new healthCheck_args();
      sendBase("healthCheck", args);
    }

    public boolean recv_healthCheck() throws TException
    {
    ...
    public void send_listMovies(String filmName, String keyWord, String actor) throws TException
    {
    ...
    public ListMovieResult recv_listMovies() throws GenericMIRestException, TException
    {
    ...
    public void send_rentMovie(RentalInfo rentalInfo) throws TException
    {
    ...
    public RentMovieResult recv_rentMovie() throws GenericMIRestException, TException
    {
    ...
    public void send_listStores(int filmId) throws TException
    {
    ...
    public ListStoreResult recv_listStores() throws GenericMIRestException, TException
    {
    ...
    public void send_returnMovie(ReturnInfo returnInfo) throws TException
    {
    ...
    public ReturnMovieResult recv_returnMovie() throws GenericMIRestException, TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class healthCheck_call extends org.apache.thrift.async.TAsyncMethodCall<Boolean> {
      public healthCheck_call(org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
    ...
    public static class listMovies_call extends org.apache.thrift.async.TAsyncMethodCall<ListMovieResult> {
      ...
      public ListMovieResult getResult() throws GenericMIRestException, TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public static class rentMovie_call extends org.apache.thrift.async.TAsyncMethodCall<RentMovieResult> {
      ...
      public rentMovie_call(RentalInfo rentalInfo, org.apache.thrift.async.AsyncMethodCallback<RentMovieResult> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
      ...
      public RentMovieResult getResult() throws GenericMIRestException, TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public static class listStores_call extends org.apache.thrift.async.TAsyncMethodCall<ListStoreResult> {
      private int filmId;
      public listStores_call(int filmId, org.apache.thrift.async.AsyncMethodCallback<ListStoreResult> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.filmId = filmId;
      }
      ...
      public ListStoreResult getResult() throws GenericMIRestException, TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public static class returnMovie_call extends org.apache.thrift.async.TAsyncMethodCall<ReturnMovieResult> {
      ...
      public returnMovie_call(ReturnInfo returnInfo, org.apache.thrift.async.AsyncMethodCallback<ReturnMovieResult> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
      ...
      public ReturnMovieResult getResult() throws GenericMIRestException, TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class healthCheck<I extends Iface> extends org.apache.thrift.ProcessFunction<I, healthCheck_args> {
      ...
      public healthCheck_result getResult(I iface, healthCheck_args args) throws TException {
        healthCheck_result result = new healthCheck_result();
    ...
    public static class listMovies<I extends Iface> extends org.apache.thrift.ProcessFunction<I, listMovies_args> {
      ...
      public listMovies_result getResult(I iface, listMovies_args args) throws TException {
        listMovies_result result = new listMovies_result();
        try {
    ...
    public static class rentMovie<I extends Iface> extends org.apache.thrift.ProcessFunction<I, rentMovie_args> {
      ...
      public rentMovie_result getResult(I iface, rentMovie_args args) throws TException {
        rentMovie_result result = new rentMovie_result();
        try {
    ...
    public static class listStores<I extends Iface> extends org.apache.thrift.ProcessFunction<I, listStores_args> {
      ...
      public listStores_result getResult(I iface, listStores_args args) throws TException {
        listStores_result result = new listStores_result();
        try {
    ...
    public static class returnMovie<I extends Iface> extends org.apache.thrift.ProcessFunction<I, returnMovie_args> {
      ...
      public returnMovie_result getResult(I iface, returnMovie_args args) throws TException {
        returnMovie_result result = new returnMovie_result();
        try {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class listMovies<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, listMovies_args, ListMovieResult> {
      ...
      public void start(I iface, listMovies_args args, org.apache.thrift.async.AsyncMethodCallback<ListMovieResult> resultHandler) throws TException {
    ...
    public static class rentMovie<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, rentMovie_args, RentMovieResult> {
      ...
      public void start(I iface, rentMovie_args args, org.apache.thrift.async.AsyncMethodCallback<RentMovieResult> resultHandler) throws TException {
    ...
    public static class listStores<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, listStores_args, ListStoreResult> {
      ...
      public void start(I iface, listStores_args args, org.apache.thrift.async.AsyncMethodCallback<ListStoreResult> resultHandler) throws TException {
    ...
    public static class returnMovie<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, returnMovie_args, ReturnMovieResult> {
      ...
      public void start(I iface, returnMovie_args args, org.apache.thrift.async.AsyncMethodCallback<ReturnMovieResult> resultHandler) throws TException {
  ...
  public static class healthCheck_args implements TBase<healthCheck_args, healthCheck_args._Fields>, java.io.Serializable, Cloneable, Comparable<healthCheck_args>   {
...
;
    ...
    private static class healthCheck_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<healthCheck_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, healthCheck_args struct) throws TException {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, healthCheck_args struct) throws TException {
        struct.validate();
    ...
    private static class healthCheck_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<healthCheck_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, healthCheck_args struct) throws TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      }

      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, healthCheck_args struct) throws TException {
  ...
  public static class healthCheck_result implements TBase<healthCheck_result, healthCheck_result._Fields>, java.io.Serializable, Cloneable, Comparable<healthCheck_result>   {
    ...
    private static class healthCheck_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<healthCheck_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, healthCheck_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, healthCheck_result struct) throws TException {
        struct.validate();
    ...
    private static class healthCheck_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<healthCheck_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, healthCheck_result struct) throws TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, healthCheck_result struct) throws TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
  ...
  public static class listMovies_args implements TBase<listMovies_args, listMovies_args._Fields>, java.io.Serializable, Cloneable, Comparable<listMovies_args>   {
    ...
    private static class listMovies_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<listMovies_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, listMovies_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, listMovies_args struct) throws TException {
        struct.validate();
    ...
    private static class listMovies_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<listMovies_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, listMovies_args struct) throws TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet optionals = new java.util.BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, listMovies_args struct) throws TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
  ...
  public static class listMovies_result implements TBase<listMovies_result, listMovies_result._Fields>, java.io.Serializable, Cloneable, Comparable<listMovies_result>   {
    ...
    private static class listMovies_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<listMovies_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, listMovies_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, listMovies_result struct) throws TException {
        struct.validate();
    ...
    private static class listMovies_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<listMovies_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, listMovies_result struct) throws TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet optionals = new java.util.BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, listMovies_result struct) throws TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
  ...
  public static class rentMovie_args implements TBase<rentMovie_args, rentMovie_args._Fields>, java.io.Serializable, Cloneable, Comparable<rentMovie_args>   {
    ...
    private static class rentMovie_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<rentMovie_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, rentMovie_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, rentMovie_args struct) throws TException {
        struct.validate();
    ...
    private static class rentMovie_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<rentMovie_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, rentMovie_args struct) throws TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet optionals = new java.util.BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, rentMovie_args struct) throws TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.rentalInfo = new RentalInfo();
  ...
  public static class rentMovie_result implements TBase<rentMovie_result, rentMovie_result._Fields>, java.io.Serializable, Cloneable, Comparable<rentMovie_result>   {
    ...
    private static class rentMovie_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<rentMovie_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, rentMovie_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, rentMovie_result struct) throws TException {
        struct.validate();
    ...
    private static class rentMovie_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<rentMovie_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, rentMovie_result struct) throws TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet optionals = new java.util.BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, rentMovie_result struct) throws TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet incoming = iprot.readBitSet(2);
        if (incoming.get(0)) {
          struct.success = new RentMovieResult();
  ...
  public static class listStores_args implements TBase<listStores_args, listStores_args._Fields>, java.io.Serializable, Cloneable, Comparable<listStores_args>   {
    ...
    private static class listStores_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<listStores_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, listStores_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, listStores_args struct) throws TException {
        struct.validate();
    ...
    private static class listStores_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<listStores_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, listStores_args struct) throws TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet optionals = new java.util.BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, listStores_args struct) throws TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.filmId = iprot.readI32();
  ...
  public static class listStores_result implements TBase<listStores_result, listStores_result._Fields>, java.io.Serializable, Cloneable, Comparable<listStores_result>   {
    ...
    private static class listStores_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<listStores_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, listStores_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, listStores_result struct) throws TException {
        struct.validate();
    ...
    private static class listStores_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<listStores_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, listStores_result struct) throws TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet optionals = new java.util.BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, listStores_result struct) throws TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet incoming = iprot.readBitSet(2);
        if (incoming.get(0)) {
          struct.success = new ListStoreResult();
  ...
  public static class returnMovie_args implements TBase<returnMovie_args, returnMovie_args._Fields>, java.io.Serializable, Cloneable, Comparable<returnMovie_args>   {
    ...
    private static class returnMovie_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<returnMovie_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, returnMovie_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, returnMovie_args struct) throws TException {
        struct.validate();
    ...
    private static class returnMovie_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<returnMovie_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, returnMovie_args struct) throws TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet optionals = new java.util.BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, returnMovie_args struct) throws TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.returnInfo = new ReturnInfo();
  ...
  public static class returnMovie_result implements TBase<returnMovie_result, returnMovie_result._Fields>, java.io.Serializable, Cloneable, Comparable<returnMovie_result>   {
    ...
    private static class returnMovie_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<returnMovie_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, returnMovie_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, returnMovie_result struct) throws TException {
        struct.validate();
    ...
    private static class returnMovie_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<returnMovie_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, returnMovie_result struct) throws TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet optionals = new java.util.BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, returnMovie_result struct) throws TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet incoming = iprot.readBitSet(2);
        if (incoming.get(0)) {
          struct.success = new ReturnMovieResult();
