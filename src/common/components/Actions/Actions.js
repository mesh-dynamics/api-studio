...
class Actions extends React.Component {
    ...
    render() {
        const element = (
            <div ref={this.props.elementRef} style={{ visibility: "hidden", margin: "5px" }}>
                <Dropdown pullRight={true} className="">
                    ...
                    <Dropdown.Menu className="pull-right">
                        ...
                        <MenuItem eventKey="4" onClick={() => this.handleShow("updateGolden", "Update Assertion")}>
                            <Glyphicon glyph="cloud-upload" /> 
                            <span style={{position: "relative", bottom: "1px", paddingLeft: "7px"}}>Update Assertion</span>
                        </MenuItem>
                    </Dropdown.Menu>
                </Dropdown>
        ...
        return this.props.jsonPath && this.props.jsonPath.indexOf("<END>") < 0 ? element : "";
    }
}
