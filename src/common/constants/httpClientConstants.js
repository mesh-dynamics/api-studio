export const httpClientConstants = {
    ...
    POST_SUCCESS_SAVE_TO_COLLECTION: "httpClient/POST_SUCCESS_SAVE_TO_COLLECTION",
    POST_ERROR_SAVE_TO_COLLECTION: "httpClient/POST_ERROR_SAVE_TO_COLLECTION",
    CATCH_ERROR_SAVE_TO_COLLECTION: "httpClient/CATCH_ERROR_SAVE_TO_COLLECTION",
    POST_SUCCESS_LOAD_RECORDED_HISTORY: "httpClient/POST_SUCCESS_LOAD_RECORDED_HISTORY",
    CLOSE_SAVE_MODAL: "httpClient/CLOSE_SAVE_MODAL",
    SHOW_SAVE_MODAL: "httpClient/SHOW_SAVE_MODAL",
    ...
    POST_SUCCESS_CREATE_COLLECTION: "httpClient/POST_SUCCESS_CREATE_COLLECTION",
    POST_ERROR_CREATE_COLLECTION: "httpClient/POST_ERROR_CREATE_COLLECTION",
    CATCH_ERROR_CREATE_COLLECTION: "httpClient/CATCH_ERROR_CREATE_COLLECTION",
    SET_SELECTED_TAB_KEY: "httpClient/SET_SELECTED_TAB_KEY",
    REMOVE_TAB: "httpClient/REMOVE_TAB",
    SET_UPDATED_MODAL_USER_COLLECTION_DETAILS: "httpClient/SET_UPDATED_MODAL_USER_COLLECTION_DETAILS",
    ...
    SHOW_IMPORT_FROM_CURL_MODAL: "httpClient/SHOW_IMPORT_FROM_CURL_MODAL",
    CLOSE_IMPORT_FROM_CURL_MODAL: "httpClient/CLOSE_IMPORT_FROM_CURL_MODAL",
    UPDATE_MODAL_CURL_COMMAND: "httpClient/UPDATE_MODAL_CURL_COMMAND",
