...
class ReplayAttribute extends Component {
    ...
    renderInstances(cube) {
        ...
        if (options.length) {
            jsxContent = <div className="inline-block">
                <select class="r-att" onChange={this.handleChangeForInstance} value={cube.selectedInstance} placeholder={'Select...'}>
                    <option value="">Select Instance</option>
                    {options}
                </select>
            </div>
        } else {
            <select class="r-att" value={cube.selectedInstance} placeholder={'Select...'}>
                <option value="">Select Instance</option>
            </select>
        }
    ...
    renderAppList (cube) {
        ...
        if (options.length) {
            jsxContent = <div className="inline-block">
                <select class="r-att" onChange={this.handleChangeForApps} value={cube.selectedApp} placeholder={'Select...'}>
    ...
    renderTestIds ( cube ) {
        if (cube.testIdsReqStatus != cubeConstants.REQ_SUCCESS || cube.testIdsReqStatus == cubeConstants.REQ_NOT_DONE)
           return <select class="r-att" disabled value={cube.selectedTestId} placeholder={'Select...'}>
        ...
        if (options.length) {
            ...
            jsxContent = <div className="inline-block" key={cube.selectedTestId}>
                <select class="r-att" onChange={this.handleChangeForTestIds} value={cube.selectedTestId} placeholder={'Select...'}>
    ...
    render() {
        ...
        return (
            <div className="rep-attr">
                ...
                <span className="cube-btn" onClick={this.replay}>RUN TEST</span>&nbsp;&nbsp;
