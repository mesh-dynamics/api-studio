...
export interface IHttpRequestFormDataROProps {
  showFormData: boolean;
  formData: IFormData[];
}
class HttpRequestFormDataRO extends Component<IHttpRequestFormDataROProps> {
  render() {
    return (
      <div style={{ display: this.props.showFormData === true ? "" : "none" }}>
        ...
        {this.props.formData.map((eachParam) => {
          return (
...
export default HttpRequestFormDataRO;
