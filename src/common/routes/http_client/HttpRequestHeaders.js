...
class HttpRequestHeaders extends Component {
    ...
    handleAdd() {
        this.props.addOrRemoveParam("headers", "add");
    }

    handleDelete(id) {
        this.props.addOrRemoveParam("headers", "delete", id);
    }

    handleChange(id, evt) {
        this.props.updateParam("headers", evt.target.name, evt.target.value, id);
    }
                ...
                <div style={{ marginTop: "5px", marginRight: "7px"}}>
                    <div style={{display: "inline-block", width: "100%"}}> 
                        <Button block style={{paddingLeft: "6px", textAlign: "left"}} onClick={this.handleAdd}>
                            ...
                            <span style={{paddingRight: "14px", opacity: "0.7", fontSize: "11px"}}>Add header</span>
                        </Button>
                    </div>
                </div>
            </div>
