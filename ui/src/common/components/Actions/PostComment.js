...
const FileReport = () => (
    <div>
        <Formik
            initialValues={{ title: '', prLink: '', affects: 'allInstances', description: '', postTo: 'slack' }}
            validate={values => {
                let errors = {};
                if (!values.title) {
                ...
                /* and other goodies */
                    ...
                    <div>
                        <form className="form-horizontal" onSubmit={handleSubmit}>
                            ...
                            <div className="form-group">
                                <label className="col-sm-2 control-label">Post to</label>
                                <div className="col-sm-10">
                                    <select className="form-control"
                                        name="postTo"
                                        onChange={handleChange}
                                    ...
                                    {errors.postTo && touched.postTo && (<div>{errors.postTo}</div>)}
                                </div>
                            </div>
                            <div className="form-group" style={{marginTop: "12px", paddingTop: "12px", borderTop: "1px solid #eee"}}>
                                <div className="col-sm-offset-2 col-sm-10">
                                    <button type="submit" className="btn btn-default" disabled={isSubmitting}>Post</button>
                                </div>
                            </div>
                        </form>
                    </div>
