...
public class ThriftOverSql {
    ...
    public Span getCurrentSpan() {
        ...
        LOGGER.info("Jaeger Span (In Thrift Over Sql), Before Client Call :: " + currentSpan.toString());
        Span toReturn = JaegerThriftSpanConverter.convertSpan(currentSpan);
        LOGGER.info("Thrift Span (In Thrift Over Sql), Before Client Call :: " + toReturn.toString());
        return toReturn;
    }
