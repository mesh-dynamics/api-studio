...
public class RentMovieResult implements org.apache.thrift.TBase<RentMovieResult, RentMovieResult._Fields>, java.io.Serializable, Cloneable, Comparable<RentMovieResult> {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case NUM_UPDATES:
      if (value == null) {
        ...
        setNumUpdates((java.lang.Integer)value);
      }
      break;
  ...
  public int compareTo(RentMovieResult other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetNumUpdates()).compareTo(other.isSetNumUpdates());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNumUpdates()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("RentMovieResult(");
    boolean first = true;
