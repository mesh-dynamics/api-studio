...
public class Tag implements org.apache.thrift.TBase<io.jaegertracing.thriftjava.Tag, io.jaegertracing.thriftjava.Tag._Fields>, java.io.Serializable, Cloneable, Comparable<io.jaegertracing.thriftjava.Tag> {
   ...
   * @see TagType
   */
  public @org.apache.thrift.annotation.Nullable TagType vType; // required
  public @org.apache.thrift.annotation.Nullable String vStr; // optional
  public double vDouble; // optional
  public boolean vBool; // optional
  public long vLong; // optional
  public @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer vBinary; // optional
  ...
  private static final _Fields optionals[] = {_Fields.V_STR, _Fields.V_DOUBLE, _Fields.V_BOOL,
      _Fields.V_LONG, _Fields.V_BINARY};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(io.jaegertracing.thriftjava.Tag.class, metaDataMap);
  }
   ...
   */
  public Tag(io.jaegertracing.thriftjava.Tag other) {
  ...
  public io.jaegertracing.thriftjava.Tag deepCopy() {
    return new io.jaegertracing.thriftjava.Tag(this);
  }
  ...
  public io.jaegertracing.thriftjava.Tag setKey(@org.apache.thrift.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
   ...
   * @see TagType
   */
  public io.jaegertracing.thriftjava.Tag setVType(@org.apache.thrift.annotation.Nullable TagType vType) {
    this.vType = vType;
    return this;
  }
  ...
  public io.jaegertracing.thriftjava.Tag setVStr(@org.apache.thrift.annotation.Nullable String vStr) {
    this.vStr = vStr;
    return this;
  }
  ...
  public io.jaegertracing.thriftjava.Tag setVDouble(double vDouble) {
  ...
  public io.jaegertracing.thriftjava.Tag setVBool(boolean vBool) {
    this.vBool = vBool;
    setVBoolIsSet(true);
    return this;
  }
  ...
  public io.jaegertracing.thriftjava.Tag setVLong(long vLong) {
    this.vLong = vLong;
    setVLongIsSet(true);
    return this;
  }
  ...
  public io.jaegertracing.thriftjava.Tag setVBinary(byte[] vBinary) {
    this.vBinary = vBinary == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(vBinary.clone());
    return this;
  }

  public io.jaegertracing.thriftjava.Tag setVBinary(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer vBinary) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof io.jaegertracing.thriftjava.Tag)
      return this.equals((io.jaegertracing.thriftjava.Tag)that);
    return false;
  }

  public boolean equals(io.jaegertracing.thriftjava.Tag that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(io.jaegertracing.thriftjava.Tag other) {
    ...
    lastComparison = Boolean.valueOf(isSetVType()).compareTo(other.isSetVType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVType()) {
    ...
    lastComparison = Boolean.valueOf(isSetVStr()).compareTo(other.isSetVStr());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVStr()) {
    ...
    lastComparison = Boolean.valueOf(isSetVDouble()).compareTo(other.isSetVDouble());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVDouble()) {
    ...
    lastComparison = Boolean.valueOf(isSetVBool()).compareTo(other.isSetVBool());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVBool()) {
    ...
    lastComparison = Boolean.valueOf(isSetVLong()).compareTo(other.isSetVLong());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVLong()) {
    ...
    lastComparison = Boolean.valueOf(isSetVBinary()).compareTo(other.isSetVBinary());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVBinary()) {
  ...
  private static class TagStandardScheme extends org.apache.thrift.scheme.StandardScheme<io.jaegertracing.thriftjava.Tag> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, io.jaegertracing.thriftjava.Tag struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, io.jaegertracing.thriftjava.Tag struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TagTupleScheme extends org.apache.thrift.scheme.TupleScheme<io.jaegertracing.thriftjava.Tag> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, io.jaegertracing.thriftjava.Tag struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, io.jaegertracing.thriftjava.Tag struct) throws org.apache.thrift.TException {
