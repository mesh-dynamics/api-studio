...
public class Span implements org.apache.thrift.TBase<io.jaegertracing.thriftjava.Span, io.jaegertracing.thriftjava.Span._Fields>, java.io.Serializable, Cloneable, Comparable<io.jaegertracing.thriftjava.Span> {
  ...
  private static final org.apache.thrift.protocol.TField BAGGAGE_FIELD_DESC = new org.apache.thrift.protocol.TField("baggage", org.apache.thrift.protocol.TType.MAP, (short)12);
  ...
  public @org.apache.thrift.annotation.Nullable String operationName; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<SpanRef> references; // optional
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<Log> logs; // optional
  public @org.apache.thrift.annotation.Nullable java.util.Map<String, String> baggage; // optional
  ...
  static {
    ...
    tmpMap.put(
        _Fields.TRACE_ID_HIGH, new org.apache.thrift.meta_data.FieldMetaData("traceIdHigh", org.apache.thrift.TFieldRequirementType.REQUIRED,
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    tmpMap.put(_Fields.SPAN_ID, new org.apache.thrift.meta_data.FieldMetaData("spanId", org.apache.thrift.TFieldRequirementType.REQUIRED,
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    tmpMap.put(
        _Fields.PARENT_SPAN_ID, new org.apache.thrift.meta_data.FieldMetaData("parentSpanId", org.apache.thrift.TFieldRequirementType.REQUIRED,
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    tmpMap.put(
        _Fields.OPERATION_NAME, new org.apache.thrift.meta_data.FieldMetaData("operationName", org.apache.thrift.TFieldRequirementType.REQUIRED,
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(io.jaegertracing.thriftjava.Span.class, metaDataMap);
  }
   ...
   */
  public Span(io.jaegertracing.thriftjava.Span other) {
  ...
  public io.jaegertracing.thriftjava.Span deepCopy() {
    return new io.jaegertracing.thriftjava.Span(this);
  }
  ...
  public io.jaegertracing.thriftjava.Span setTraceIdLow(long traceIdLow) {
    this.traceIdLow = traceIdLow;
    setTraceIdLowIsSet(true);
    return this;
  }
  ...
  public io.jaegertracing.thriftjava.Span setTraceIdHigh(long traceIdHigh) {
    this.traceIdHigh = traceIdHigh;
    setTraceIdHighIsSet(true);
    return this;
  }
  ...
  public io.jaegertracing.thriftjava.Span setSpanId(long spanId) {
    this.spanId = spanId;
    setSpanIdIsSet(true);
    return this;
  }
  ...
  public io.jaegertracing.thriftjava.Span setParentSpanId(long parentSpanId) {
    this.parentSpanId = parentSpanId;
    setParentSpanIdIsSet(true);
    return this;
  }
  ...
  public io.jaegertracing.thriftjava.Span setOperationName(@org.apache.thrift.annotation.Nullable String operationName) {
    this.operationName = operationName;
    return this;
  }
  ...
  public io.jaegertracing.thriftjava.Span setReferences(@org.apache.thrift.annotation.Nullable java.util.List<SpanRef> references) {
  ...
  public io.jaegertracing.thriftjava.Span setFlags(int flags) {
    this.flags = flags;
    setFlagsIsSet(true);
    return this;
  }
  ...
  public io.jaegertracing.thriftjava.Span setStartTime(long startTime) {
    this.startTime = startTime;
    setStartTimeIsSet(true);
    return this;
  }
  ...
  public io.jaegertracing.thriftjava.Span setDuration(long duration) {
    this.duration = duration;
    setDurationIsSet(true);
    return this;
  }
  ...
  public io.jaegertracing.thriftjava.Span setTags(@org.apache.thrift.annotation.Nullable java.util.List<Tag> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public io.jaegertracing.thriftjava.Span setLogs(@org.apache.thrift.annotation.Nullable java.util.List<Log> logs) {
    this.logs = logs;
    return this;
  }
  ...
  public io.jaegertracing.thriftjava.Span setBaggage(@org.apache.thrift.annotation.Nullable java.util.Map<String, String> baggage) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof io.jaegertracing.thriftjava.Span)
      return this.equals((io.jaegertracing.thriftjava.Span)that);
    return false;
  }

  public boolean equals(io.jaegertracing.thriftjava.Span that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(io.jaegertracing.thriftjava.Span other) {
    ...
    lastComparison = Boolean.valueOf(isSetTraceIdLow()).compareTo(other.isSetTraceIdLow());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(isSetTraceIdHigh()).compareTo(other.isSetTraceIdHigh());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTraceIdHigh()) {
  ...
  private static class SpanStandardScheme extends org.apache.thrift.scheme.StandardScheme<io.jaegertracing.thriftjava.Span> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, io.jaegertracing.thriftjava.Span struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.baggage = new java.util.HashMap<String, String>(2*_map17.size);
                @org.apache.thrift.annotation.Nullable String _key18;
                @org.apache.thrift.annotation.Nullable String _val19;
                for (int _i20 = 0; _i20 < _map17.size; ++_i20)
                {
                  _key18 = iprot.readString();
                  _val19 = iprot.readString();
                  struct.baggage.put(_key18, _val19);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, io.jaegertracing.thriftjava.Span struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.references != null) {
        if (struct.isSetReferences()) {
          oprot.writeFieldBegin(REFERENCES_FIELD_DESC);
          {
            ...
            for (SpanRef _iter21 : struct.references)
            {
              _iter21.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.baggage != null) {
        if (struct.isSetBaggage()) {
          oprot.writeFieldBegin(BAGGAGE_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<String, String> _iter24 : struct.baggage.entrySet())
            {
  ...
  private static class SpanTupleScheme extends org.apache.thrift.scheme.TupleScheme<io.jaegertracing.thriftjava.Span> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, io.jaegertracing.thriftjava.Span struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetReferences()) {
        {
          ...
          for (SpanRef _iter25 : struct.references)
          {
            _iter25.write(oprot);
          }
        }
      ...
      if (struct.isSetBaggage()) {
        {
          ...
          for (java.util.Map.Entry<String, String> _iter28 : struct.baggage.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, io.jaegertracing.thriftjava.Span struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.references = new java.util.ArrayList<SpanRef>(_list29.size);
          @org.apache.thrift.annotation.Nullable SpanRef _elem30;
          for (int _i31 = 0; _i31 < _list29.size; ++_i31)
          {
            _elem30 = new SpanRef();
            _elem30.read(iprot);
            struct.references.add(_elem30);
          }
        }
        struct.setReferencesIsSet(true);
      }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.logs = new java.util.ArrayList<Log>(_list35.size);
          @org.apache.thrift.annotation.Nullable Log _elem36;
          for (int _i37 = 0; _i37 < _list35.size; ++_i37)
          {
            _elem36 = new Log();
            _elem36.read(iprot);
            struct.logs.add(_elem36);
          }
        }
        struct.setLogsIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.baggage = new java.util.HashMap<String, String>(2*_map38.size);
          @org.apache.thrift.annotation.Nullable String _key39;
          @org.apache.thrift.annotation.Nullable String _val40;
          for (int _i41 = 0; _i41 < _map38.size; ++_i41)
          {
            _key39 = iprot.readString();
            _val40 = iprot.readString();
            struct.baggage.put(_key39, _val40);
          }
        }
        struct.setBaggageIsSet(true);
      }
