...
public class Log implements org.apache.thrift.TBase<io.jaegertracing.thriftjava.Log, io.jaegertracing.thriftjava.Log._Fields>, java.io.Serializable, Cloneable, Comparable<io.jaegertracing.thriftjava.Log> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<Tag> fields; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(io.jaegertracing.thriftjava.Log.class, metaDataMap);
  }
   ...
   */
  public Log(io.jaegertracing.thriftjava.Log other) {
  ...
  public io.jaegertracing.thriftjava.Log deepCopy() {
    return new io.jaegertracing.thriftjava.Log(this);
  }
  ...
  public io.jaegertracing.thriftjava.Log setTimestamp(long timestamp) {
    this.timestamp = timestamp;
    setTimestampIsSet(true);
    return this;
  }
  ...
  public io.jaegertracing.thriftjava.Log setFields(@org.apache.thrift.annotation.Nullable java.util.List<Tag> fields) {
    this.fields = fields;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof io.jaegertracing.thriftjava.Log)
      return this.equals((io.jaegertracing.thriftjava.Log)that);
    return false;
  }

  public boolean equals(io.jaegertracing.thriftjava.Log that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(io.jaegertracing.thriftjava.Log other) {
  ...
  private static class LogStandardScheme extends org.apache.thrift.scheme.StandardScheme<io.jaegertracing.thriftjava.Log> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, io.jaegertracing.thriftjava.Log struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, io.jaegertracing.thriftjava.Log struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class LogTupleScheme extends org.apache.thrift.scheme.TupleScheme<io.jaegertracing.thriftjava.Log> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, io.jaegertracing.thriftjava.Log struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, io.jaegertracing.thriftjava.Log struct) throws org.apache.thrift.TException {
