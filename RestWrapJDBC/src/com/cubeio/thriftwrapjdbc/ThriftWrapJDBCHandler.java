...
public class ThriftWrapJDBCHandler implements Iface {
    ...
    public String query(String query, String params, Span span)
        ...
        try (Scope scope = startServerSpan(span, "serverQuery")) {
            ...
            throw new GenericThriftWrapException("Query failed: " + query + "; " + params + "; " + e.toString());
        }
    }
    ...
    public String update(String queryAndParam, Span span)
        ...
        try (Scope scope = startServerSpan(span, "updateQuery")) {
            ...
            throw new GenericThriftWrapException("Update query failed: " + queryAndParam + "; " + e.toString());
        }
    }
