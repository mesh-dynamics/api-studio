...
public class Span implements org.apache.thrift.TBase<Span, Span._Fields>, java.io.Serializable, Cloneable, Comparable<Span> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> baggage; // optional
  ...
  private static final _Fields optionals[] = {_Fields.REFERENCES,_Fields.TAGS,_Fields.LOGS,_Fields.BAGGAGE};
  ...
  public Span setBaggage(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> baggage) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.baggage = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map17.size);
      ...
      if (struct.baggage != null) {
        if (struct.isSetBaggage()) {
          oprot.writeFieldBegin(BAGGAGE_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter24 : struct.baggage.entrySet())
            {
      ...
      if (struct.isSetBaggage()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter28 : struct.baggage.entrySet())
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.baggage = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map38.size);
