...
public class Tag implements org.apache.thrift.TBase<Tag, Tag._Fields>, java.io.Serializable, Cloneable, Comparable<Tag> {
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String vStr; // optional
  ...
  public Tag setKey(@org.apache.thrift.annotation.Nullable java.lang.String key) {
    this.key = key;
    return this;
  }
  ...
  public Tag setVStr(@org.apache.thrift.annotation.Nullable java.lang.String vStr) {
    this.vStr = vStr;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case V_STR:
      if (value == null) {
        ...
        setVStr((java.lang.String)value);
      }
      break;
    ...
    case V_DOUBLE:
      if (value == null) {
        ...
        setVDouble((java.lang.Double)value);
      }
      break;
    ...
    case V_BOOL:
      if (value == null) {
        ...
        setVBool((java.lang.Boolean)value);
      }
      break;
  ...
  public int compareTo(Tag other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetVType()).compareTo(other.isSetVType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVType()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetVStr()).compareTo(other.isSetVStr());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVStr()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetVDouble()).compareTo(other.isSetVDouble());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVDouble()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetVBool()).compareTo(other.isSetVBool());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVBool()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetVLong()).compareTo(other.isSetVLong());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVLong()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetVBinary()).compareTo(other.isSetVBinary());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVBinary()) {
        ...
        switch (schemeField.id) {
          ...
          case 2: // V_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.vType = io.jaegertracing.thriftjava.TagType.findByValue(iprot.readI32());
